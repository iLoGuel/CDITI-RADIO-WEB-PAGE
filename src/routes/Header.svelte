...
<header>
  <nav class="max-w-screen-xl m-auto w-auto py-4 px-5 flex justify-between items-center">
    ...
    <button class="sm:hidden hover:shadow py-2 px-4 font-bold hover:bg-secondary hover:text-primary transition-all rounded-xl cursor-pointer flex"><i class="fa-solid fa-bars"></i></button>
